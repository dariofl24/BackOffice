...
var allFeatures = (function() { 
    ...
    var init = function(){
        ...
        FaceBook_feature.init().done(function () {
            ...
            //console.log("**** FB User::: "+ FaceBook_feature.getuser().name + " - "+ FaceBook_feature.cache.user.name + " + " + FaceBook_feature.FBUSER.name + " + "+ FaceBook_feature.myuser.name);
